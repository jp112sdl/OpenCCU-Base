...
public:
	 ...
	 */
	inline unsigned long GetAddress(){return 1;};
	 ...
	 */
    std::string GetDeviceDescription(unsigned long address);
	 ...
	 *  \return \c true bei erfolgreicher Sendung
	 */
    bool SendMessage(unsigned long receiver, const std::string &msg, std::string *response);
	 ...
	 *  \return \c true bei erfolgreicher Sendung
	 */
    bool SendBootloaderMessage(unsigned long receiver, const std::string &msg, std::string *response);
	 ...
	 */
    int Discovery(std::vector<unsigned long>* devices);
	 ...
	 */
	void ClearAddressInfo(unsigned long address=0xffffffff);
...
protected:
	 ...
	 *          \c true sonst.
	 */
	bool CheckRxCounter(unsigned long receiver, unsigned char cc);
	 ...
	 *  HS485-Control-Character und inkrementiert den Sendefolgezähler im AddressInfo
	 */
	void UpdateControlChar(unsigned long receiver, unsigned char* cc);
